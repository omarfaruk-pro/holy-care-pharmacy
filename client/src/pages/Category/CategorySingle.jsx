...
export default function CategorySingle() {
    ...
    const { data: products = [], isLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosSecure.get(`/products/${params.name}/category?search=${searchTerm}&sort=${sortOrder}`);
            return res.data;
        }
    });
        ...
        <section className="p-6">
            <div className="container">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold">Category: {params.name} {products.length}</h2>
