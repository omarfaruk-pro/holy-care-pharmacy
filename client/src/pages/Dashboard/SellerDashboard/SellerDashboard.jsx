...
const SellerDashboard = () => {
  ...
  const { data = {}, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosSecure.get(`/seller/summery?sellerId=${userId}`);
      return res.data;
    },
    enabled: !!userId,
  });
  ...
  const { totalOrders = 0, totalProductsSold = 0, paidRevenue = 0, pendingRevenue = 0 } = data;


  return (
    <>
      <h1 className="text-4xl font-bold mb-10 text-center">Seller Dashboard</h1>
      {
        isLoading &&
          ...
          <div className="card bg-base-100 shadow-md hover:shadow-xl cursor-default transition-transform duration-200 hover:scale-105">
            <div className="card-body">
              <Link to='/dashboard/user-payments' className="flex flex-col gap-1 items-center justify-between">
                ...
                <div className="text-center">
                  <h2 className="text-2xl font-bold">{totalProductsSold}</h2>
                  <p className="text-gray-500">Total Products Sold</p>
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className="card bg-base-100 shadow-md hover:shadow-xl cursor-default transition-transform duration-200 hover:scale-105">
            <div className="card-body">
              <Link to='/dashboard/user-payments' className="flex flex-col gap-1 items-center justify-between">
                ...
                <div className="text-center">
                  <h2 className="text-2xl font-bold">${paidRevenue}</h2>
          ...
          <div className="card bg-base-100 shadow-md hover:shadow-xl cursor-default transition-transform duration-200 hover:scale-105">
            <div className="card-body">
              <Link to='/dashboard/user-payments' className="flex flex-col gap-1 items-center justify-between">
                ...
                <div className="text-center">
                  <h2 className="text-2xl font-bold">${pendingRevenue}</h2>
